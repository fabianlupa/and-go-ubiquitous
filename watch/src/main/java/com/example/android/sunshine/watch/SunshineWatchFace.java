...
public class SunshineWatchFace extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            float textSizeSec = resources.getDimension(isRound
                    ? R.dimen.digital_text_size_round_sec : R.dimen.digital_text_size_sec);

            mTextPaint.setTextSize(textSize);
            mTextSecondaryPaint.setTextSize(textSizeSec);
        }
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            canvas.drawLine(bounds.centerX() - 100f, bounds.centerY(), bounds.centerX() + 100f,
